...
class BankAccount {
    ...
    withdraw(amount) {
        if (this.balance >= amount) {
            this.balance -= amount;
            console.log(chalk.bold.blue(`Withdrawal of $${amount} succesful.Remaining balance: $${this.balance}`));
        }
        else {
    ...
    deposit(amount) {
        ...
        this.balance += amount;
        console.log(chalk.bold.blue(`Deposit of $${amount} successful.Remaining balance: $${this.balance}`));
    }
    //Check balance
    checkBalance() {
